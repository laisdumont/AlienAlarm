...
def start(theme):
    ...
    #     nivel = Buttons("{}nv1".format(theme), 185, 45)
    #     piece1 = Buttons("pieces/{}piece{}{}".format(theme, card_img[0], card_rot[0]), 816, 95)
    #     piece2 = Buttons("pieces/{}piece{}{}".format(theme, card_img[1], card_rot[1]), 816, 225)
    #     piece3 = Buttons("pieces/{}piece{}{}".format(theme, card_img[2], card_rot[2]), 816, 355)
    #     piece4 = Buttons("pieces/{}piece{}{}".format(theme, card_img[3], card_rot[3]), 816, 485)
    #     piece5 = Buttons("pieces/{}piece{}{}".format(theme, card_img[4], card_rot[4]), 816, 615)
    ...
    #     SCREEN.blit(nivel.image, nivel.rect)
